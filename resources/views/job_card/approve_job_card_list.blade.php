...
@section('title','Approve Job Card List | Motors Service')
<style>
    label {
        font-size: 11px;
    }
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @endif
                    <form role="form" action="{{url('/approve_job_card')}}" method="get">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            @foreach ($job_cards as $job_card)
                             <tr style="@if($job_card->is_approved == 0){{'background-color:#ff9999;'}}@endif">
                              ...
                              <td>@if($job_card->is_approved){{"Approved"}}
                                  <br>{{isset($job_card->approver) ? $job_card->approver->name : ''}}
                                  @else
