    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('kpia_detail.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_101_115_mul') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_101_115_mul" type="number" id="incentive_101_115_mul" class="form-control"   value="{{ old('incentive_101_115_mul') }}"    autofocus step="any"  placeholder="Incentive 101 115 mul"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_116_140_mul') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_116_140_mul" type="number" id="incentive_116_140_mul" class="form-control"   value="{{ old('incentive_116_140_mul') }}"    autofocus step="any"  placeholder="Incentive 116 140 mul"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_141_above_mul') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_141_above_mul" type="number" id="incentive_141_above_mul" class="form-control"   value="{{ old('incentive_141_above_mul') }}"    autofocus step="any"  placeholder="Incentive 141 above mul"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_101_115_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_101_115_amount" type="number" id="incentive_101_115_amount" class="form-control"   value="{{ old('incentive_101_115_amount') }}"    autofocus step="any"  placeholder="Incentive 101 115 amount"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_116_140_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_116_140_amount" type="number" id="incentive_116_140_amount" class="form-control"   value="{{ old('incentive_116_140_amount') }}"    autofocus step="any"  placeholder="Incentive 116 140 amount"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('incentive_141_above_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="incentive_141_above_amount" type="number" id="incentive_141_above_amount" class="form-control"   value="{{ old('incentive_141_above_amount') }}"    autofocus step="any"  placeholder="Incentive 141 above amount"     >
...
<script>document.title = 'KpiaDetail | Create';</script>
@endsection
