    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('engineer_report_com.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="report_actual" type="number" id="report_actual" class="form-control"   value="{{ old('report_actual') }}"    autofocus step="any"  required  placeholder="Report actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_dashboard_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="app_dashboard_actual" type="number" id="app_dashboard_actual" class="form-control"   value="{{ old('app_dashboard_actual') }}"    autofocus step="any"  required  placeholder="App dashboard actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_coordination_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="team_coordination_actual" type="number" id="team_coordination_actual" class="form-control"   value="{{ old('team_coordination_actual') }}"    autofocus step="any"  required  placeholder="Team coordination actual"     >
...
<script>document.title = 'EngineerReportCom | Create';</script>
@endsection
