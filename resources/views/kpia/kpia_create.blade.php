    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('kpia.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('total_incentive_bonus') ? 'has-error' : '' }}">
                        ...
                        <input name="total_incentive_bonus" type="number" id="total_incentive_bonus" class="form-control"   value="{{ old('total_incentive_bonus') }}"    autofocus step="any"  required  placeholder="Total incentive bonus"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('total_kpi_mark') ? 'has-error' : '' }}">
                        ...
                        <input name="total_kpi_mark" type="number" id="total_kpi_mark" class="form-control"   value="{{ old('total_kpi_mark') }}"    autofocus step="any"  required  placeholder="Total kpi mark"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('total_incentive_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="total_incentive_amount" type="number" id="total_incentive_amount" class="form-control"   value="{{ old('total_incentive_amount') }}"    autofocus step="any"  required  placeholder="Total incentive amount"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_ws_target') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_ws_target" type="number" id="service_ratio_ws_target" class="form-control"   value="{{ old('service_ratio_ws_target') }}"    autofocus step="any"  placeholder="Service ratio ws target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_ws_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_ws_actual" type="number" id="service_ratio_ws_actual" class="form-control"   value="{{ old('service_ratio_ws_actual') }}"    autofocus step="any"  placeholder="Service ratio ws actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_ws_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_ws_weight" type="number" id="service_ratio_ws_weight" class="form-control"   value="{{ old('service_ratio_ws_weight') }}"    autofocus placeholder="Service ratio ws weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_ws_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_ws_score" type="number" id="service_ratio_ws_score" class="form-control"   value="{{ old('service_ratio_ws_score') }}"    autofocus step="any"  placeholder="Service ratio ws score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_ws_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_ws_f_score" type="number" id="service_ratio_ws_f_score" class="form-control"   value="{{ old('service_ratio_ws_f_score') }}"    autofocus step="any"  placeholder="Service ratio ws f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_pws_target') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_pws_target" type="number" id="service_ratio_pws_target" class="form-control"   value="{{ old('service_ratio_pws_target') }}"    autofocus step="any"  placeholder="Service ratio pws target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_pws_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_pws_actual" type="number" id="service_ratio_pws_actual" class="form-control"   value="{{ old('service_ratio_pws_actual') }}"    autofocus step="any"  placeholder="Service ratio pws actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_pws_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_pws_weight" type="number" id="service_ratio_pws_weight" class="form-control"   value="{{ old('service_ratio_pws_weight') }}"    autofocus placeholder="Service ratio pws weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_pws_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_pws_score" type="number" id="service_ratio_pws_score" class="form-control"   value="{{ old('service_ratio_pws_score') }}"    autofocus step="any"  placeholder="Service ratio pws score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_ratio_pws_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_ratio_pws_f_score" type="number" id="service_ratio_pws_f_score" class="form-control"   value="{{ old('service_ratio_pws_f_score') }}"    autofocus step="any"  placeholder="Service ratio pws f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_six_target') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_six_target" type="number" id="satisfaction_index_six_target" class="form-control"   value="{{ old('satisfaction_index_six_target') }}"    autofocus step="any"  placeholder="Satisfaction index six target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_six_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_six_actual" type="number" id="satisfaction_index_six_actual" class="form-control"   value="{{ old('satisfaction_index_six_actual') }}"    autofocus step="any"  placeholder="Satisfaction index six actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_six_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_six_weight" type="number" id="satisfaction_index_six_weight" class="form-control"   value="{{ old('satisfaction_index_six_weight') }}"    autofocus placeholder="Satisfaction index six weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_six_score') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_six_score" type="number" id="satisfaction_index_six_score" class="form-control"   value="{{ old('satisfaction_index_six_score') }}"    autofocus step="any"  placeholder="Satisfaction index six score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_six_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_six_f_score" type="number" id="satisfaction_index_six_f_score" class="form-control"   value="{{ old('satisfaction_index_six_f_score') }}"    autofocus step="any"  placeholder="Satisfaction index six f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_csi_target') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_csi_target" type="number" id="satisfaction_index_csi_target" class="form-control"   value="{{ old('satisfaction_index_csi_target') }}"    autofocus step="any"  placeholder="Satisfaction index csi target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_csi_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_csi_actual" type="number" id="satisfaction_index_csi_actual" class="form-control"   value="{{ old('satisfaction_index_csi_actual') }}"    autofocus step="any"  placeholder="Satisfaction index csi actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_csi_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_csi_weight" type="number" id="satisfaction_index_csi_weight" class="form-control"   value="{{ old('satisfaction_index_csi_weight') }}"    autofocus placeholder="Satisfaction index csi weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_csi_score') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_csi_score" type="number" id="satisfaction_index_csi_score" class="form-control"   value="{{ old('satisfaction_index_csi_score') }}"    autofocus step="any"  placeholder="Satisfaction index csi score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('satisfaction_index_csi_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="satisfaction_index_csi_f_score" type="number" id="satisfaction_index_csi_f_score" class="form-control"   value="{{ old('satisfaction_index_csi_f_score') }}"    autofocus step="any"  placeholder="Satisfaction index csi f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_target') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_target" type="number" id="service_income_target" class="form-control"   value="{{ old('service_income_target') }}"    autofocus step="any"  placeholder="Service income target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_actual" type="number" id="service_income_actual" class="form-control"   value="{{ old('service_income_actual') }}"    autofocus step="any"  placeholder="Service income actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_weight" type="number" id="service_income_weight" class="form-control"   value="{{ old('service_income_weight') }}"    autofocus placeholder="Service income weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_score" type="number" id="service_income_score" class="form-control"   value="{{ old('service_income_score') }}"    autofocus step="any"  placeholder="Service income score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_f_score" type="number" id="service_income_f_score" class="form-control"   value="{{ old('service_income_f_score') }}"    autofocus step="any"  placeholder="Service income f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_submission_target') ? 'has-error' : '' }}">
                        ...
                        <input name="report_submission_target" type="number" id="report_submission_target" class="form-control"   value="{{ old('report_submission_target') }}"    autofocus placeholder="Report submission target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_submission_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="report_submission_actual" type="number" id="report_submission_actual" class="form-control"   value="{{ old('report_submission_actual') }}"    autofocus placeholder="Report submission actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_submission_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="report_submission_weight" type="number" id="report_submission_weight" class="form-control"   value="{{ old('report_submission_weight') }}"    autofocus placeholder="Report submission weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_submission_score') ? 'has-error' : '' }}">
                        ...
                        <input name="report_submission_score" type="number" id="report_submission_score" class="form-control"   value="{{ old('report_submission_score') }}"    autofocus step="any"  placeholder="Report submission score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('report_submission_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="report_submission_f_score" type="number" id="report_submission_f_score" class="form-control"   value="{{ old('report_submission_f_score') }}"    autofocus step="any"  placeholder="Report submission f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_monitor_target') ? 'has-error' : '' }}">
                        ...
                        <input name="app_monitor_target" type="number" id="app_monitor_target" class="form-control"   value="{{ old('app_monitor_target') }}"    autofocus placeholder="App monitor target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_monitor_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="app_monitor_actual" type="number" id="app_monitor_actual" class="form-control"   value="{{ old('app_monitor_actual') }}"    autofocus placeholder="App monitor actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_monitor_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="app_monitor_weight" type="number" id="app_monitor_weight" class="form-control"   value="{{ old('app_monitor_weight') }}"    autofocus placeholder="App monitor weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_monitor_score') ? 'has-error' : '' }}">
                        ...
                        <input name="app_monitor_score" type="number" id="app_monitor_score" class="form-control"   value="{{ old('app_monitor_score') }}"    autofocus step="any"  placeholder="App monitor score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('app_monitor_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="app_monitor_f_score" type="number" id="app_monitor_f_score" class="form-control"   value="{{ old('app_monitor_f_score') }}"    autofocus step="any"  placeholder="App monitor f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_co_target') ? 'has-error' : '' }}">
                        ...
                        <input name="team_co_target" type="number" id="team_co_target" class="form-control"   value="{{ old('team_co_target') }}"    autofocus placeholder="Team co target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_co_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="team_co_actual" type="number" id="team_co_actual" class="form-control"   value="{{ old('team_co_actual') }}"    autofocus placeholder="Team co actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_co_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="team_co_weight" type="number" id="team_co_weight" class="form-control"   value="{{ old('team_co_weight') }}"    autofocus placeholder="Team co weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_co_score') ? 'has-error' : '' }}">
                        ...
                        <input name="team_co_score" type="number" id="team_co_score" class="form-control"   value="{{ old('team_co_score') }}"    autofocus step="any"  placeholder="Team co score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('team_co_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="team_co_f_score" type="number" id="team_co_f_score" class="form-control"   value="{{ old('team_co_f_score') }}"    autofocus step="any"  placeholder="Team co f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_f_score_total') ? 'has-error' : '' }}">
                        ...
                        <input name="service_f_score_total" type="number" id="service_f_score_total" class="form-control"   value="{{ old('service_f_score_total') }}"    autofocus step="any"  placeholder="Service f score total"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_f_score_percent') ? 'has-error' : '' }}">
                        ...
                        <input name="service_f_score_percent" type="number" id="service_f_score_percent" class="form-control"   value="{{ old('service_f_score_percent') }}"    autofocus step="any"  placeholder="Service f score percent"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_total_incentive') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_total_incentive" type="number" id="service_income_total_incentive" class="form-control"   value="{{ old('service_income_total_incentive') }}"    autofocus step="any"  placeholder="Service income total incentive"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_target') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_target" type="number" id="sp_tractor_target" class="form-control"   value="{{ old('sp_tractor_target') }}"    autofocus step="any"  placeholder="Sp tractor target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_actual" type="number" id="sp_tractor_actual" class="form-control"   value="{{ old('sp_tractor_actual') }}"    autofocus step="any"  placeholder="Sp tractor actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_weight" type="number" id="sp_tractor_weight" class="form-control"   value="{{ old('sp_tractor_weight') }}"    autofocus placeholder="Sp tractor weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_score" type="number" id="sp_tractor_score" class="form-control"   value="{{ old('sp_tractor_score') }}"    autofocus step="any"  placeholder="Sp tractor score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_f_score" type="number" id="sp_tractor_f_score" class="form-control"   value="{{ old('sp_tractor_f_score') }}"    autofocus step="any"  placeholder="Sp tractor f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_f_score_total') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_f_score_total" type="number" id="sp_tractor_f_score_total" class="form-control"   value="{{ old('sp_tractor_f_score_total') }}"    autofocus step="any"  placeholder="Sp tractor f score total"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_f_score_percent') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_f_score_percent" type="number" id="sp_tractor_f_score_percent" class="form-control"   value="{{ old('sp_tractor_f_score_percent') }}"    autofocus step="any"  placeholder="Sp tractor f score percent"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_total_incentive') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_total_incentive" type="number" id="sp_tractor_total_incentive" class="form-control"   value="{{ old('sp_tractor_total_incentive') }}"    autofocus step="any"  placeholder="Sp tractor total incentive"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_target') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_target" type="number" id="sp_nmpt_target" class="form-control"   value="{{ old('sp_nmpt_target') }}"    autofocus step="any"  placeholder="Sp nmpt target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_actual" type="number" id="sp_nmpt_actual" class="form-control"   value="{{ old('sp_nmpt_actual') }}"    autofocus step="any"  placeholder="Sp nmpt actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_weight" type="number" id="sp_nmpt_weight" class="form-control"   value="{{ old('sp_nmpt_weight') }}"    autofocus placeholder="Sp nmpt weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_score" type="number" id="sp_nmpt_score" class="form-control"   value="{{ old('sp_nmpt_score') }}"    autofocus step="any"  placeholder="Sp nmpt score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_f_score" type="number" id="sp_nmpt_f_score" class="form-control"   value="{{ old('sp_nmpt_f_score') }}"    autofocus step="any"  placeholder="Sp nmpt f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_f_score_total') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_f_score_total" type="number" id="sp_nmpt_f_score_total" class="form-control"   value="{{ old('sp_nmpt_f_score_total') }}"    autofocus step="any"  placeholder="Sp nmpt f score total"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_f_score_percent') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_f_score_percent" type="number" id="sp_nmpt_f_score_percent" class="form-control"   value="{{ old('sp_nmpt_f_score_percent') }}"    autofocus step="any"  placeholder="Sp nmpt f score percent"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_total_incentive') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_total_incentive" type="number" id="sp_nmpt_total_incentive" class="form-control"   value="{{ old('sp_nmpt_total_incentive') }}"    autofocus step="any"  placeholder="Sp nmpt total incentive"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_target') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_target" type="number" id="sp_tractor_plus_nmpt_target" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_target') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_actual') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_actual" type="number" id="sp_tractor_plus_nmpt_actual" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_actual') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_weight') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_weight" type="number" id="sp_tractor_plus_nmpt_weight" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_weight') }}"    autofocus placeholder="Sp tractor plus nmpt weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_score" type="number" id="sp_tractor_plus_nmpt_score" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_score') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_f_score" type="number" id="sp_tractor_plus_nmpt_f_score" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_f_score') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt f score"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_f_score_total') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_f_score_total" type="number" id="sp_tractor_plus_nmpt_f_score_total" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_f_score_total') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt f score total"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_f_score_percent') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_f_score_percent" type="number" id="sp_tractor_plus_nmpt_f_score_percent" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_f_score_percent') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt f score percent"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_total_incentive') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_total_incentive" type="number" id="sp_tractor_plus_nmpt_total_incentive" class="form-control"   value="{{ old('sp_tractor_plus_nmpt_total_incentive') }}"    autofocus step="any"  placeholder="Sp tractor plus nmpt total incentive"     >
...
<script>document.title = 'Kpia | Create';</script>
@endsection
