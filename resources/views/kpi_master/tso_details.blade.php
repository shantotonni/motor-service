                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    if ($val >= 60 && $val < 80){
                                        $serVal = ($val * $serviceIncomeWeight) / 80;
                                        $serviceIncomeScoreConditional = round($serVal, 2);
                                    }
...
{{--                                @php $serviceIncomeFinalScore= $serviceIncomeScore; @endphp--}}
                            ...
                            <tr>
                                ...
                                <th>
                                    <?php
                                        $totalWeightAgainstService = $totalWarrantyServiceWeight+$indexTotalWeight+$serviceIncomeWeight + $operationWeight;
                                    ?>
                                    {{ $totalWeightAgainstService }}
                                </th>
                                <th></th>
                                <th>
                                    <?php
                                    $FinalScoreAgainstService = $totalWarrantyServiceFinalScore + $indexTotalFinalScore + $serviceIncomeFinalScore + $operationFinalScore;
                                    ?>
                                    {{ $FinalScoreAgainstService }}
                                </th>
                            </tr>
                            @php
                                if ($kpi->designation == 'SS'){
                                    $ServiceAmount = 5600;
                                }else{
                                    $ServiceAmount = 4900;
                                }
                            ...
                            <tr>
                                <td></td>
                                <th>Incentive Amount Against Service</th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th>
                                    <?php
                                    if ($FinalScoreAgainstService >= 56){
                                        $TotalServiceIncome = ($FinalScoreAgainstService / $totalWeightAgainstService) * $ServiceAmount;
                                    }else{
                            ...
                            <tr>
                                ...
                                if ($kpi->spare_parts_target > 0){
                                        ...
                                        if ($val2 >= 60 && $val2 < 80){
                                            $sparVal = ($val2 * $serviceIncomeWeight)/80;
                                            $sparePartsFinalScoreConditional = round($sparVal, 2);
                                        }
...
{{--                                @php $sparePartsFinalScore = round(($sparePartsScore * $sparePartsWeight)/8, 2); @endphp--}}
                            ...
                            @php
                                if ($kpi->designation == 'SS'){
                                    $SparePartsAmount = 2400;
                                }else{
                                    $SparePartsAmount = 2100;
                                }
                            @endphp
                            <tr>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <th>Incentive Amount Against Spare parts</th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th>
                                    <?php
                                    if ($sparePartsFinalScore >= 24){
                                        $TotalSparePartsIncome = ($sparePartsFinalScore / $sparePartsWeight) * $SparePartsAmount;
                                    }else{
                                        $TotalSparePartsIncome = 0;
                                    }
                                    ?>
                                    {{ $TotalSparePartsIncome }}
                                </th>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="offset-sm-2 col-sm-8">
                                <table class="table table-bordered small table-sm">
                                    <tbody>
                                        ...
                                        @php 
                                        if($baselineIncentivePercent <= 80){ $baselineIncentivePercent=0; } $totalServiceIncentiveAmount=round((($designationBase->service_base_amount*$baselineIncentivePercent)/100), 2);
                                        @endphp
                                        <tr>
                                            <th colspan="2">Total Incentive Amount</th>
                                            <th class="text-center">{{$TotalServiceIncome + $TotalSparePartsIncome}}</th>
{{--                                            <th class="text-center">{{$totalServiceIncentiveAmount}}</th>--}}
            ...
            <div style="font-size: 13px;padding-top:1%;">
                <div>
                    <img src="{{asset('/img/shahed_sig.png')}}" height="20" width="100" alt="signature" style="margin-left: 13px;">
