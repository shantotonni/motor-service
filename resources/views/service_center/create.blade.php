...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Service Center Create</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">ServiceCenter</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="" role="form" method="POST" action="{{ route('service-center.store') }}">
                                {{ csrf_field() }}
                                <div class="row">
    ...
    <script>document.title = 'Service Center | Create';</script>
@endsection
