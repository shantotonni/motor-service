...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">UserKpiDetail Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('user_kpi_detail.update',$user_kpi_detail->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('user_kpi_id') ? 'has-error' : '' }}">
                        ...
                        <select name="user_kpi_id" id="user_kpi_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($user_kpis as $user_kpi)
                             <option value="{{$user_kpi->id}}"  @if($user_kpi->id == $user_kpi_detail->user_kpi_id){{"selected"}} @endif >{{$user_kpi->name}}</option>
                        @endforeach
                        </select>
                    ...
                    <div class="form-group{{ $errors->has('kpi_topic_id') ? 'has-error' : '' }}">
                        ...
                        <select name="kpi_topic_id" id="kpi_topic_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($kpi_topics as $kpi_topic)
                             <option value="{{$kpi_topic->id}}"  @if($kpi_topic->id == $user_kpi_detail->kpi_topic_id){{"selected"}} @endif >{{$kpi_topic->name}}</option>
                        @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('target') ? 'has-error' : '' }}">
                        ...
                        <input name="target" type="number" id="target" class="form-control"   value="{{$user_kpi_detail->target}}"    autofocus step="any"  placeholder="Target"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('actual') ? 'has-error' : '' }}">
                        ...
                        <input name="actual" type="number" id="actual" class="form-control"   value="{{$user_kpi_detail->actual}}"    autofocus step="any"  placeholder="Actual"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('weight') ? 'has-error' : '' }}">
                        ...
                        <input name="weight" type="number" id="weight" class="form-control"   value="{{$user_kpi_detail->weight}}"    autofocus step="any"  placeholder="Weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('score') ? 'has-error' : '' }}">
                        ...
                        <input name="score" type="number" id="score" class="form-control"   value="{{$user_kpi_detail->score}}"    autofocus step="any"  placeholder="Score"     >
                        @if ($errors->has('score'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('f_score') ? 'has-error' : '' }}">
                        ...
                        <input name="f_score" type="number" id="f_score" class="form-control"   value="{{$user_kpi_detail->f_score}}"    autofocus step="any"  placeholder="F score"     >
...
<script>document.title = 'UserKpiDetail | Edit';</script>
@endsection
