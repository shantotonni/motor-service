                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('PurReqDate') ? 'has-error' : '' }}">
                                    ...
                                    <input name="PurReqDate" type="text" id="PurReqDate" class="form-control datepicker"   value="{{ old('PurReqDate') }}"   required autofocus   placeholder="PurReqDate"     >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('ExpiryDate') ? 'has-error' : '' }}">
                                    ...
                                    <input name="ExpiryDate" type="text" id="ExpiryDate" class="form-control datepicker"   value="{{ old('ExpiryDate') }}"   required autofocus  placeholder="ExpiryDate"     >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('DeliveryPlace') ? 'has-error' : '' }}">
                                    ...
                                    <input name="DeliveryPlace" type="text" id="DeliveryPlace" class="form-control"   value="{{ old('DeliveryPlace') }}"   required autofocus   placeholder="DeliveryPlace"     >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('ExpectedDelDate') ? 'has-error' : '' }}">
                                    ...
                                    <input name="ExpectedDelDate" type="text" id="ExpectedDelDate" class="form-control datepicker"   value="{{ old('ExpectedDelDate') }}"   required autofocus   placeholder="ExpectedDelDate"     >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('RequisitionDetails') ? 'has-error' : '' }}">
                                    ...
                                    <input name="RequisitionDetails" type="text" id="RequisitionDetails" class="form-control"   value="{{ old('RequisitionDetails') }}"   required autofocus   placeholder="RequisitionDetails"     >
                            ...
                            <thead>
                                ...
                                <th style="width: 250px;">
                                    ...
                                    <select name="ItemCode" id="ItemCode" data-live-search="true" class="form-control select2" style="width: 100%;" required autofocus type="select"     >
                                        ...
                                        <option value="{{$item->ItemCode}}" data-UOM="{{$item->UOM}}">{{$item->ItemCode}} - {{$item->ItemName}} - {{$item->UOM}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <th><input name="Quantity" type="number" id="Quantity" class="form-control"     required autofocus   placeholder="Qty"></th>    
                                <th><input name="Rates" type="number" id="Rates" class="form-control"     required autofocus   placeholder="Expected Rate"></th>
