        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">SSR Expense Create</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-warning">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="" role="form" method="POST" action="{{ route('store.ssr.expense') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group{{ $errors->has('user_id') ? 'has-error' : '' }}">
                                        ...
                                        <select name="user_id" id="user_id" data-live-search="true" class="form-control select2 ssrName" autofocus type="select" required>
                                            ...
                                            <option value="{{$ssr->id}}">{{$ssr->name}} ( {{$ssr->username}} )</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('opening_km') ? 'has-error' : '' }}">
                                        ...
                                        <input name="opening_km" type="number" id="opening_km" class="form-control" value="{{ old('opening_km') }}" autofocus  required placeholder="Opening km">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('closing_km') ? 'has-error' : '' }}">
                                        ...
                                        <input name="closing_km" type="number" id="closing_km" class="form-control" value="{{ old('closing_km') }}" autofocus  placeholder="Closing km">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('bike_no') ? 'has-error' : '' }}">
                                        ...
                                        <input name="bike_no" type="text" id="bike_no" class="form-control" value="{{ old('bike_no') }}" autofocus  required placeholder="Bike No">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('period') ? 'has-error' : '' }}">
                                        ...
                                        <input name="period" type="text" id="period" class="form-control" value="{{ old('period') }}" autofocus autocomplete="off"  required placeholder="Period">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('opening_image') ? 'has-error' : '' }}">
                                        ...
                                        <input name="opening_image" type="file" id="opening_image" class="form-control-file" value="{{ old('opening_image') }}" autofocus required>
...
<script>
    document.title = 'SSR Expense | Create';
</script>
