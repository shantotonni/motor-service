    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('role.update',$role->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                        ...
                        <input name="code" type="text" id="code" class="form-control"   value="{{$role->code}}"    autofocus max="191"  required  placeholder="Code"     >
                        @if ($errors->has('code'))
