...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Service Manager Information Create</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="{{ route('service-manager.store') }}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-6">
...
<script>document.title = 'Service Manager Info | Create';</script>
@endsection
