        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Sales Product Edit</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-warning">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="" role="form" method="POST" action="{{ route('sales-products.update',$product->id ) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <input name="name" type="text" id="name" class="form-control" value="{{$product->name}}" autofocus max="191" required placeholder="Name">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('sales_product_category_id') ? 'has-error' : '' }}">
                                        ...
                                        <select name="sales_product_category_id" id="sales_product_category_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                                            ...
                                            @foreach($categories as $cat)
                                                @if($cat->id==$product->sales_product_category_id)
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group {{ $errors->has('detail') ? 'has-error' : '' }}">
                                        ...
                                        <textarea id="summernote" name="detail">{{$product->detail}}</textarea>
...
<script>
    document.title = 'Sales Product Category | Edit';
</script>
@endsection
