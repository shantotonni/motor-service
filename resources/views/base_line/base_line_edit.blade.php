...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">BaseLine Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('base_line.update',$base_line->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('kpi_type_id') ? 'has-error' : '' }}">
                        ...
                        <select name="kpi_type_id" id="kpi_type_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus required     >
                            ...
                            @foreach($kpi_types as $kpi_type)
                             <option value="{{$kpi_type->id}}"  @if($kpi_type->id == $base_line->kpi_type_id){{"selected"}} @endif >{{$kpi_type->name}}</option>
                        @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_base_line') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_base_line" type="number" id="service_income_base_line" class="form-control"   value="{{$base_line->service_income_base_line}}"    autofocus placeholder="Service income base line"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_base_line') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_base_line" type="number" id="sp_tractor_base_line" class="form-control"   value="{{$base_line->sp_tractor_base_line}}"    autofocus placeholder="Sp tractor base line"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_nmpt_base_line') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_nmpt_base_line" type="number" id="sp_nmpt_base_line" class="form-control"   value="{{$base_line->sp_nmpt_base_line}}"    autofocus placeholder="Sp nmpt base line"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sp_tractor_plus_nmpt_base_line') ? 'has-error' : '' }}">
                        ...
                        <input name="sp_tractor_plus_nmpt_base_line" type="number" id="sp_tractor_plus_nmpt_base_line" class="form-control"   value="{{$base_line->sp_tractor_plus_nmpt_base_line}}"    autofocus placeholder="Sp tractor plus nmpt base line"     >
...
<script>document.title = 'BaseLine | Edit';</script>
@endsection
