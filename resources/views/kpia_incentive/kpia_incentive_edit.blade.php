...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">KpiaIncentive Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('kpia_incentive.update',$kpia_incentive->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('kpia_id') ? 'has-error' : '' }}">
                        ...
                        <select name="kpia_id" id="kpia_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($kpia as $kpium)
                             <option value="{{$kpium->id}}"  @if($kpium->id == $kpia_incentive->kpia_id){{"selected"}} @endif >{{$kpium->name}}</option>
                        @endforeach
                        </select>
                    ...
                    <div class="form-group{{ $errors->has('incentive_factor_id') ? 'has-error' : '' }}">
                        ...
                        <select name="incentive_factor_id" id="incentive_factor_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($incentive_factors as $incentive_factor)
                             <option value="{{$incentive_factor->id}}"  @if($incentive_factor->id == $kpia_incentive->incentive_factor_id){{"selected"}} @endif >{{$incentive_factor->name}}</option>
                        @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('multiplier') ? 'has-error' : '' }}">
                        ...
                        <input name="multiplier" type="number" id="multiplier" class="form-control"   value="{{$kpia_incentive->multiplier}}"    autofocus step="any"  placeholder="Multiplier"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor" type="number" id="tractor" class="form-control"   value="{{$kpia_incentive->tractor}}"    autofocus step="any"  placeholder="Tractor"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('nmpt') ? 'has-error' : '' }}">
                        ...
                        <input name="nmpt" type="number" id="nmpt" class="form-control"   value="{{$kpia_incentive->nmpt}}"    autofocus step="any"  placeholder="Nmpt"     >
                        @if ($errors->has('nmpt'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor_and_nmpt') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor_and_nmpt" type="number" id="tractor_and_nmpt" class="form-control"   value="{{$kpia_incentive->tractor_and_nmpt}}"    autofocus step="any"  placeholder="Tractor and nmpt"     >
...
<script>document.title = 'KpiaIncentive | Edit';</script>
@endsection
