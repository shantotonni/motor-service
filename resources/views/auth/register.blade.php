                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="mobile" class="form-control @error('mobile') is-invalid @enderror" name="mobile" max="11" value="{{ old('mobile') }}" required autocomplete="mobile">
                        ...
                        <div class="form-group row">
                            <label for="is_ssr" class="col-md-4 col-form-label text-md-right">{{ __('Is SSR') }}</label>
                            <div class="col-md-6">
                                <input id="is_ssr" type="checkbox" class="form-control" name="is_ssr">
                            </div>
                        </div>
