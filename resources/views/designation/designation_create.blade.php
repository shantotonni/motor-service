    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('designation.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input name="name" type="text" id="name" class="form-control"   value="{{ old('name') }}"   required autofocus max="50"  placeholder="Name"     >
                        @if ($errors->has('name'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                        ...
                        <input name="code" type="text" id="code" class="form-control"   value="{{ old('code') }}"   required autofocus max="50"  placeholder="Code"     >
                        @if ($errors->has('code'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_base_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="service_base_amount" type="number" id="service_base_amount" class="form-control"   value="{{ old('service_base_amount') }}"   required autofocus  placeholder="Service base amount"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor_parts_base_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor_parts_base_amount" type="number" id="tractor_parts_base_amount" class="form-control"   value="{{ old('tractor_parts_base_amount') }}"   required autofocus   placeholder="Tractor parts base amount"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('nm_parts_base_amount') ? 'has-error' : '' }}">
                        ...
                        <input name="nm_parts_base_amount" type="number" id="nm_parts_base_amount" class="form-control"   value="{{ old('nm_parts_base_amount') }}"   required autofocus   placeholder="NM/PTDE parts base amount"     >
...
<script>document.title = 'Designation | Create';</script>
@endsection
