...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Sales Manager Information Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <form class="" role="form" method="POST" action="{{ route('sales-manager-info.update',$salesManager->id) }}">
                            {{ csrf_field() }}
                            @method('PATCH')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <input name="name" type="text" id="name" class="form-control" value="{{ $salesManager->name }}" required autofocus>
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('mobile_number') ? 'has-error' : '' }}">
                                        ...
                                        <input name="mobile_number" type="text" id="mobile_number" class="form-control" value="{{ $salesManager->mobile_number }}" required autofocus">
                                    ...
                                    <div class="form-group{{ $errors->has('area_id') ? 'has-error' : '' }}">
                                        ...
                                        <select name="area_id" id="area_id" data-live-search="true" class="form-control select2" style="width: 100%;" required autofocus type="select">
                                            ...
                                            @foreach($areas as $area)
                                                @if ($salesManager->area_id == $area->id)
...
<script>document.title = 'Sales Manager Info | Edit';</script>
@endsection
