        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{url('/product/create')}}"><button class="btn btn-sm btn-info float-right btn-flat">Create Product</button></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($products as $product)
                      ...
                      <td>
                          <a href="{{url('/product/'.$product->id)}}" title="Show" ><button type="button" class="btn btn-xs btn-primary btn-flat">Show</button></a>
                          <a href="{{url('/product/'.$product->id.'/edit')}}" title="Edit" ><button type="button" class="btn btn-xs btn-info btn-flat">Edit</button></a>
...
$(document).on("click", "#openDeleteModal", function () {
     ...
     $("#delete_modal_form").attr("action", "{{url('/product')}}/" + delId);
