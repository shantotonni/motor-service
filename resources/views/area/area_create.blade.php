    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('area.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('name_bn') ? 'has-error' : '' }}">
                        ...
                        <input name="name_bn" type="text" id="name_bn" class="form-control"   value="{{ old('name_bn') }}"    autofocus max="191"  required  placeholder="Name in Bengali"     >
...
<script>document.title = 'Area | Create';</script>
@endsection
