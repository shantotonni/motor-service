            ...
            <div class="col-12">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input name="name" type="text" id="name" class="form-control"   value="{{$company->name}}"   required autofocus max="100"  placeholder="Name"     >
                        @if ($errors->has('name'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                        ...
                        <input name="code" type="text" id="code" class="form-control"   value="{{$company->code}}"   required autofocus max="20"  placeholder="Code"     >
                        @if ($errors->has('code'))
