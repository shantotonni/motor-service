...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">UserKpiCode Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('user_kpi_code.update',$user_kpi_code->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('user_id') ? 'has-error' : '' }}">
                        ...
                        <select name="user_id" id="user_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($users as $user)
                             <option value="{{$user->id}}"  @if($user->id == $user_kpi_code->user_id){{"selected"}} @endif >{{$user->name}}</option>
                        @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('service_income_code') ? 'has-error' : '' }}">
                        ...
                        <input name="service_income_code" type="text" id="service_income_code" class="form-control"   value="{{$user_kpi_code->service_income_code}}"    autofocus max="191"  placeholder="Service income code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor_spare_parts_code') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor_spare_parts_code" type="text" id="tractor_spare_parts_code" class="form-control"   value="{{$user_kpi_code->tractor_spare_parts_code}}"    autofocus max="191"  placeholder="Tractor spare parts code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor_sonalika_lub_code') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor_sonalika_lub_code" type="text" id="tractor_sonalika_lub_code" class="form-control"   value="{{$user_kpi_code->tractor_sonalika_lub_code}}"    autofocus max="191"  placeholder="Tractor sonalika lub code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('tractor_power_oil_code') ? 'has-error' : '' }}">
                        ...
                        <input name="tractor_power_oil_code" type="text" id="tractor_power_oil_code" class="form-control"   value="{{$user_kpi_code->tractor_power_oil_code}}"    autofocus max="191"  placeholder="Tractor power oil code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('nm_spare_parts_code') ? 'has-error' : '' }}">
                        ...
                        <input name="nm_spare_parts_code" type="text" id="nm_spare_parts_code" class="form-control"   value="{{$user_kpi_code->nm_spare_parts_code}}"    autofocus max="191"  placeholder="Nm spare parts code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('nm_power_oil_code') ? 'has-error' : '' }}">
                        ...
                        <input name="nm_power_oil_code" type="text" id="nm_power_oil_code" class="form-control"   value="{{$user_kpi_code->nm_power_oil_code}}"    autofocus max="191"  placeholder="Nm power oil code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('pt_spare_parts_code') ? 'has-error' : '' }}">
                        ...
                        <input name="pt_spare_parts_code" type="text" id="pt_spare_parts_code" class="form-control"   value="{{$user_kpi_code->pt_spare_parts_code}}"    autofocus max="191"  placeholder="Pt spare parts code"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('pt_power_oil_code') ? 'has-error' : '' }}">
                        ...
                        <input name="pt_power_oil_code" type="text" id="pt_power_oil_code" class="form-control"   value="{{$user_kpi_code->pt_power_oil_code}}"    autofocus max="191"  placeholder="Pt power oil code"     >
...
<script>document.title = 'UserKpiCode | Edit';</script>
@endsection
