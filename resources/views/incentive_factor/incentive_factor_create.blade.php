...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">IncentiveFactor Create</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('incentive_factor.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('from') ? 'has-error' : '' }}">
                        ...
                        <input name="from" type="number" id="from" class="form-control"   value="{{ old('from') }}"    autofocus required  placeholder="From"     >
                        @if ($errors->has('from'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('to') ? 'has-error' : '' }}">
                        ...
                        <input name="to" type="number" id="to" class="form-control"   value="{{ old('to') }}"    autofocus required  placeholder="To"     >
                        @if ($errors->has('to'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('multiplication_factor') ? 'has-error' : '' }}">
                        ...
                        <input name="multiplication_factor" type="number" id="multiplication_factor" class="form-control"   value="{{ old('multiplication_factor') }}"    autofocus step="any"  required  placeholder="Multiplication factor"     >
...
<script>document.title = 'IncentiveFactor | Create';</script>
@endsection
