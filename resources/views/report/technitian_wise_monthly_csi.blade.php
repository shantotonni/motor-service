    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
          ...
          <div class="card"> 
            ...
            <div class="card-body">
                <h4>Technician Wise Monthly CSI Report {{date('M-Y',strtotime(request()->get('date')))}} (For {{ $TypeName }})
...
{{--                                  <td>{{$job_card->no_of_feedback}}</td>--}}
                                  <td>{{$job_card->noOfService}}</td>
                                  <td>{{$job_card->CSI}}</td>
                                  <td>100</td>

                                  <?php
                                  $grandTotalMarks += $job_card->CSI;
                                  $total_job_card += $job_card->noOfService;
                                  ?>
...
{{--                                      0--}}
{{--                                  @else--}}
{{--                                      {{round($grandTotalMarks*100/100,2)}}--}}
{{--                                  @endif--}}
