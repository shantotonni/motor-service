    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
          ...
          <div class="card"> 
            ...
            <div class="card-body">
                <h4>Technician Wise Monthly Report - {{date('Y-m-d',strtotime($front_date))}}
                <a href="" onclick="exportF(this,'job_card','technician_wise_monthly_report{{date('d_m_Y')}}')" id="bt"><button class="btn btn-flat btn-success" style="float:right;" >ExportExcel</button></a>
