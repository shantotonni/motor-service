...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">KpiTopic Edit</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('kpi_topic.update',$kpi_topic->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input name="name" type="text" id="name" class="form-control"   value="{{$kpi_topic->name}}"    autofocus max="191"  required  placeholder="Name"     >
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group{{ $errors->has('kpi_type_id') ? 'has-error' : '' }}">
                        ...
                        <select name="kpi_type_id" id="kpi_type_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus required     >
                            ...
                            @foreach($kpi_types as $kpi_type)
                             <option value="{{$kpi_type->id}}"  @if($kpi_type->id == $kpi_topic->kpi_type_id){{"selected"}} @endif >{{$kpi_type->name}}</option>
                        @endforeach
                        </select>
                    ...
                    <div class="form-group{{ $errors->has('kpi_group_id') ? 'has-error' : '' }}">
                        ...
                        <select name="kpi_group_id" id="kpi_group_id" data-live-search="true" class="form-control select2" style="width: 100%;"  autofocus type="select"  required     >
                            ...
                            @foreach($kpi_groups as $kpi_group)
                             <option value="{{$kpi_group->id}}"  @if($kpi_group->id == $kpi_topic->kpi_group_id){{"selected"}} @endif >{{$kpi_group->name}}</option>
                        @endforeach
                        </select>
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('sl') ? 'has-error' : '' }}">
                        ...
                        <input name="sl" type="text" id="sl" class="form-control"   value="{{$kpi_topic->sl}}"    autofocus max="191"  placeholder="Sl"     >
                        @if ($errors->has('sl'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('mark') ? 'has-error' : '' }}">
                        ...
                        <input name="mark" type="number" id="mark" class="form-control"   value="{{$kpi_topic->mark}}"    autofocus step="any"  placeholder="Mark"     >
                        @if ($errors->has('mark'))
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('ach_from') ? 'has-error' : '' }}">
                        ...
                        <input name="ach_from" type="number" id="ach_from" class="form-control"   value="{{$kpi_topic->ach_from}}"    autofocus placeholder="Ach from"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('ach_to') ? 'has-error' : '' }}">
                        ...
                        <input name="ach_to" type="number" id="ach_to" class="form-control"   value="{{$kpi_topic->ach_to}}"    autofocus placeholder="Ach to"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('weight') ? 'has-error' : '' }}">
                        ...
                        <input name="weight" type="number" id="weight" class="form-control"   value="{{$kpi_topic->weight}}"    autofocus placeholder="Weight"     >
                ...
                <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('multiplication_factor') ? 'has-error' : '' }}">
                        ...
                        <input name="multiplication_factor" type="number" id="multiplication_factor" class="form-control"   value="{{$kpi_topic->multiplication_factor}}"    autofocus step="any"  placeholder="Multiplication factor"     >
...
<script>document.title = 'KpiTopic | Edit';</script>
@endsection
